...
/**
 * PostgreSQL-specific exception with additional error fields.
 */
public class PgException extends DbException {
    ...
    public PgException(String severity, String sqlState, String message,
                       ...
                       String schema, String table, String column, String constraint) {
    ...
    public static PgException fromErrorResponse(BackendMessage.ErrorResponse err) {
        return new PgException(err.severity(), err.code(), err.message(),
            err.detail(), err.hint(),
