...
class PgDecoderTest {
  ...
  void decodeErrorResponse() throws IOException {
    ...
    buf.writeByte('C');
    buf.writeCString("42P01");
    buf.writeByte('M');
    buf.writeCString("relation \"foo\" does not exist");
    buf.writeByte('D');
    buf.writeCString("some detail");
    buf.writeByte('H');
    buf.writeCString("some hint");
  ...
  void decodeNoticeResponse() throws IOException {
    ...
    buf.writeByte('S');
    buf.writeCString("WARNING");
    buf.writeByte('C');
    buf.writeCString("01000");
    buf.writeByte('M');
    buf.writeCString("some warning");
    buf.writeByte(0);
