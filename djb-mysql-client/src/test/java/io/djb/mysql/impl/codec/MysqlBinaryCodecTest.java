...
class MysqlBinaryCodecTest {
    ...
    void decodeUnsignedInt3() {
        ...
        assertEquals(0xFFFFFF, codec.decodeUnsignedInt3(new byte[]{(byte) 0xFF, (byte) 0xFF, (byte) 0xFF, 0}));
    }

    @Test
    void decodeUnsignedInt4() {
        // 0xFFFFFFFF → 4294967295L
        assertEquals(4294967295L, codec.decodeUnsignedInt4(new byte[]{(byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF}));
    }
