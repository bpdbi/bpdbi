...
public final class Row {
    ...
    /**
     * Get a column value mapped to the given type using the registered {@link MapperRegistry}.
     */
    public <T> T get(int index, Class<T> type) {
        if (values[index] == null) return null;
        if (mapperRegistry == null) {
            throw new IllegalStateException(
                "No MapperRegistry set on this Row. Set one via connection.setMapperRegistry().");
        }
    ...
    /** Set the mapper registry for generic typed access. */
